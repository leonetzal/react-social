...
import DefaultImageProfile from '../images/post-default.png'
    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                <img style={{ height: "200px", width: 'auto' }} className="img-thumbnail" src={`${process.env.REACT_APP_API_URL}/post/picture/${id}?${new Date().getTime()}`} onError={i => (i.target.src = DefaultImageProfile)} alt={title} />
